module.exports = (req, res, next) => {
    ...
    res.header('access-control-allow-mmethods', 'GET, POST, PUT, DELETE');
...
/**
 Cross-Origin Resource Sharing
    ...
    2: a response header that specifies the method or methods allowed when accessing the resources to preflight request.
